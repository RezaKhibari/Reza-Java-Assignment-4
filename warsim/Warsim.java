...
public class Warsim {
  ...
  public static Weather currentWeather; // current weather
  ...
  public static void main(String[] args) {
    ...
    ink.welcome();
    setWeather(); // set the weather 
    ink.printWeather(currentWeather.getWeatherName()); // get weather
    ...
    while(!gameOver) {
      if(playerTurn) {
        ...
        if(attackType == 5) { // Surrender option
          gameOver = true;
          winner = "Enemy";
        ...
        damage = pWeapon.strike(attackType, 
          player.getDexterity(),
          player.getStrength());
        damage = (int) currentWeather.modifyDamage(damage);
  ...
  private static void setWeather() {
    ...
    int weatherChoice = randNum.nextInt(3);
